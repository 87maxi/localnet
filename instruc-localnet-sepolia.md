...
Este proyecto se configura para desplegar un entorno localnet vinculada a la testnet sepolia de Ethereum utilizando servicios definidos en `docker-compose.yml`. Los servicios principales incluyen Geth, Blockscout y varios servicios adicionales para verificación de contratos, visualización y estadísticas.
